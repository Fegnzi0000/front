...
export default function ProfilePage() {
  ...
  return <View className='page profile-page'>
    ...
    <View className='profile-hero' onClick={() => Taro.navigateTo({ url: '/pages/profile/edit/index' })}><View className='profile-avatar'>饭</View><View className='profile-copy'><Text className='profile-name'>{user?.nickname??''}</Text><Text className='profile-email'>{user?.email ?? '未绑定邮箱'}</Text><Text className='profile-edit'>编辑昵称 ›</Text></View></View>
